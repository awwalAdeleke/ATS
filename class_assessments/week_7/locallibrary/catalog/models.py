...
# verbose_name - As labels to the field
# help_text - As helpful text to the field so that users can know how to interact with the field.
...
class Language(models.Model):
    ...
    language_type = models.CharField(max_length=20, help_text="Enter your language of the book you want(e.g English, Farsi)")
...
class Book(models.Model):
    ...
    # can have many books (One to Many)
    # Authors as a string rather than an object because it hasn't been
...
class BookInstance(models.Model):
    ...
    language = models.ManyToManyField(Language, help_text="Select your language for this book")
