...
def create_question(question_text, days):
    ...
    Args:
        question_text (Question): _description_
        days (datetime): _description_
    """
...
class QuestionIndexViewTests(TestCase):
    def test_no_question(self):
        ...
        self.assertQuerysetEqual(response.context['latest_question_list'], [])  # type: ignore
    ...
    def test_past_question(self):
        ...
        self.assertQuerysetEqual(
            response.context['latest_question_list'],  # type: ignore
            [question],
        )
    ...
    def test_two_past_questions(self):
        ...
        response = self.client.get(reverse("polls:index"))
        self.assertQuerysetEqual(
            response.context["latest_question_text"],  # type: ignore
            [question2,question1],
            )
